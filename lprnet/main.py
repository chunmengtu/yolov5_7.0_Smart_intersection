                    ...
                    *xyxy, conf, cls = de
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        for a, i in enumerate(lic_plat):
                            ...
                            lb += CHARS[int(i)]
                        label = '%s %.2f' % (lb, conf)
                        im0 = plot_one_box(xyxy, im0, label=label, color=(0, 0, 0), line_thickness=4)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--det-weights', nargs='+', type=str, default='./weights/yolov5_best.pt',
                        help='model.pt path(s)')
    parser.add_argument('--rec-weights', nargs='+', type=str, default='./weights/lprnet_best.pth',
                        help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='demo/images/cut.mp4', help='source')  # file/folder, 0 for webcam
